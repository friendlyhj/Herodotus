...
Casting.addTableRecipe(<tconstruct:cast_custom:4>, <ore:gearStone>, <liquid:aluminium_brass>, 144, true, 200);
Casting.addTableRecipe(<tconstruct:cast_custom:4>, <pyrotech:cog_bone>, <liquid:aluminium_brass>, 144, true, 200);
Casting.addTableRecipe(<tconstruct:cast_custom:4>, <pyrotech:cog_flint>, <liquid:aluminium_brass>, 144, true, 200);
...
Casting.addTableRecipe(<thaumcraft:quicksilver>, null, <liquid:mercury>, 500, false, 20);
}
